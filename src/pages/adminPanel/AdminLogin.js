...
//       try {
//         //const response = await axios.post('http://localhost:7777/adminLogin/login', data);
//         const response = await axios.post('https://buildwell-engineering.vercel.app/adminLogin/login', data);
...
//                   <input type="email" className="form-control" id="email" name="email" value={data.email} onChange={handleChange} aria-describedby="emailHelp" />
//                 </div>
//                 <div className="mb-3 position-relative">
//                   <label htmlFor="password" className="form-label">Password</label>
//                   <div className="input-group flex-nowrap">
//                     <input type={showPassword ? "text" : "password"} className="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping" name="password" value={data.password} onChange={handleChange} />
//                     <span className="input-group-text" id="addon-wrapping">
//                     <button type="button" className="btn btn-link show-hide-btn p-0 m-0 text-decoration-none" onClick={togglePasswordVisibility} style={{lineHeight:'100%'}}>
