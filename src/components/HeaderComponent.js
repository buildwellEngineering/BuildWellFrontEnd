  ...
  return (
    <header className="header d-flex justify-content-center align-items-center">
        ...
        <div className="header-content container px-sm-2 px-md-3 d-flex justify-content-center align-items-md-center flex-column">
          {/* <h1>LEADERS IN QUALITY</h1> */} <h1 className='' style={{textShadow:'0 0 2px black'}}>{text1}</h1>
          {/* <h2>CONSTRUCTION AND</h2> */} <h2 style={{textShadow:'0 0 2px black'}}>{text2}</h2>
          {/* <h2 className="pb-4"><span>INFRASTRUCTURE</span></h2> */} <h2 className='pb-4' style={{textShadow:'0 0 2px black'}}><span>{text3}</span></h2>
